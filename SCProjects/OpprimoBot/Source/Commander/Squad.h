...
public:
	...
	//Brandon added
	int getSquadMaxSpread();
	int getMoveState();
	void setMoveState(int);
	double getSpread();

	//Brandon added - Move states for flocking
	/**Allow bot normal movement*/
	static const int MSTATE_NORMAL = 0;
	/**Force bot into convergence movement*/
	static const int MSTATE_CONVERGE = 1;
};
